...
@section('content')
        <div class="flex w-full justify-between items-center">
            ...
            <form action="import" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="flex">
                        <input type="file" name="file" placeholder="Import csv file" class="border border-gray-300 rounded-md mr-3">
                        <button class="text-white block flex-initial bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Import</button>
                    </div>
                </form>
            <a
                class="text-white block flex-initial bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
